...
########## Otp settings Users ##########
        ...
        self.ui_button_setpasswdusers = Gtk.Button(label=_("Set Password Users"))
        ...
        self.ui_button_delogretmen = Gtk.Button(label=_("Del Ogretmen"))
        self.ui_box_settings.pack_start(self.ui_button_delogretmen, False, False, 0)
        
        self.ui_button_delogrenci = Gtk.Button(label=_("Del Ogrenci"))
