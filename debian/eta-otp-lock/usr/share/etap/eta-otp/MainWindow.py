...
class MainWindow:
    ...
    def on_createusers_event(self, widget):
        ...
        self.info_dialog(_("Info"), _("Users are being added. (turkce,matematik, sosyal, fen, bilisim, gorsel, muzik, dikab, felsefe, turkdili, yabancidil) Please wait..."))
        users = [
        ...
        self.info_dialog(_("Info"), _("Users added..."))
            
    def on_setpasswdusers_event(self, widget):
        self.info_dialog(_("Info"), _("User passwords will be changed."))
        ...
        for username in users:
            ...
            try:
                ...
                print(f"Hata: {e}")
        self.info_dialog(_("Info"), _("User passwords have been changed."))
    ...
    def on_delusers_event(self, widget):
        ...
        self.info_dialog(_("Info"), _("Users Deleted."))
